...
EvaluationDatasetPath = fullfile('D:','欠陥検出','画像データ','3種類の分類','評価データ');
VotesFilePath = 'D:\欠陥検出\AlexNet\評価投票結果\3種類の分類\';
ModelPath = 'D:\欠陥検出\AlexNet\モデル\3種類の分類\';
ModelName = 'AModel_Jan_17_2019_02_27';
FileExtensions = '.tif';
ensembleNum = 7;
...
TableTitle = {'画像','正解','カス付','ニック跡','水滴','除外'};
